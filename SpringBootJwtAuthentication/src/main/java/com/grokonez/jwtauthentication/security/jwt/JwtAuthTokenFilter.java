...
public class JwtAuthTokenFilter extends OncePerRequestFilter {
    ...
    private String getJwt(HttpServletRequest request) {
        String authHeader = request.getHeader("Authorization");//Authorization
        	
        if (authHeader != null && authHeader.startsWith(Constants.TOKENTYPE+" ")) {
        	return authHeader.replace(Constants.TOKENTYPE+" ","");
        }
